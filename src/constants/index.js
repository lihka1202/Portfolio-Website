...
const projects = [
  ...
  {
    name: 'Snoopy',
    description: 'A chrome extension that can keep track of the webpages that a user visits and hyperlinks generated by those webpages. Keeps users informed of the links and potential threats they are exposed to.',
    tags: [
      {
        name: 'ChromeOS',
        color: 'blue-text-gradient',
  ...
  },
  {
    ...
    description:
      "This is the portfolio website! If you haven't realized yet, the computer model in the first section and the balls in the second section are movable 3D models. Just click and drag your mouse to see them move!",
    tags: [
      {
        name: 'reactjs',
        color: 'blue-text-gradient',
